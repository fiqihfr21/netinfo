...
@section('content')
  ...
  <div class="container">
    <div class="row col-sm-6 col-sm-offset-3">
      <h1 align="center">Thank you for your report</h1><hr>
      <p align="center">your report will be our follow-up</p><br>
      <a href="{{url('user')}}" class="btn btn-info col-sm-12">Back</a>
    </div>
  </div>
@endsection
